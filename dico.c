...
void afficherMots(char *mot, Noeud *noeud)
{
    if (noeud != NULL)
    {
        if (noeud->caractere != '\0')
        {
            ...
            {
char charArray[2] = {noeud->caractere, '\0'};
strcpy(mot + strlen(mot), charArray);
        ...
        {
            printf("mot: '%s' existe %i fois \n",mot, noeud->nbrOccurrence);//aficher mot
...
{
    printf("\n______________________________________________DICTIONNAIRE______________________________________________\n");
    char mot[100] = "";
    afficherMots(mot, a);
...
void lettrespercentage( TArbre a){
	 char c;
	         ...
	         printf("___________________________________________Frequence des lettres___________________________________________\n");
